...
# Print target variable, input features, and corresponding predictions
if True:
    predictions = pd.DataFrame({'Target': y_test, 'Predictions': y_pred.flatten()})
    print(predictions)
